...
(function() {
  ...
  cookieCommand = (function(_super) {
    ...
    cookieCommand.prototype.getCookie = function() {
      var c, cookies;
      cookies = ["a cupcake", "an apple", "an icecream", "a kiss", "a bit of cocaine", "a bit of fun", "an icegurt", "a coffe", "bananas", "a toy", "a zanrion", "peanuts", "a room lowlat"];
    ...
    cookieCommand.prototype.functionality = function() {
      ...
      if (msg.substring(7, 8) === "@") {
        ...
        if (user === false) {
          API.sendChat("/em: I didn't found ' " + msg.substr(8) +  "' in the room. More for me! d(>_<)b ");
          return false;
        } else {
  ...
  newSongsCommand = (function(_super) {
    ...
    newSongsCommand.prototype.functionality = function() {
     ...
     msg = "Everybody heard " + selections['artist'] + " get new songs in http://youtube.com/" + selections['channels'][0] + " http://youtube.com/" + selections['channels'][1] + " ou http://youtube.com/" + selections['channels'][2];
  ...
  themeCommand = (function(_super) {
    ...
    themeCommand.prototype.functionality = function() {
      var msg1, msg2;
      msg1 = " All kind of eletronic music is allowed here. Like: Electro, Dubstep, Tech, Trap Music, EDM, Hardstyle and Trance. ";
      msg1 += "Hardstyle, House e Trance. ";
      msg2 = "Enjoy this shiet ";
      msg2 += "bai. ";	  
      API.sendChat(msg1);
  ...
  rulesCommand = (function(_super) {
    ...
    rulesCommand.prototype.functionality = function() {
      var msg1, msg2;
       msg1 = "1) Time limit 6 minutes and 30 seconds. ";
      msg1 += "2) Don't write in /me or /em.  ";
      msg1 += "3) Respect the moderators of the room.";
      msg1 += "4) Don't flood in our chat. ";
      msg1 += "5) Don't ask if you can be a staff ";
      API.sendChat(msg1);
      return setTimeout((function() {
        return API.sendChat(msg2);
      }), 750);
  ...
  statusCommand = (function(_super) {
    ...
    statusCommand.prototype.functionality = function() {
      ...
      launch = 'Launched in ' + day + '/' + month + ' ' + hour + ':' + min + ' ' + meridian + '. ';
      msg = launch;
      return API.sendChat(msg);
    };
  ...
  staffCommand = (function(_super) {
    ...
    staffCommand.prototype.staff = function() {
      ...
      if (stringstaff.length === 0) {
        stringstaff = "Seems no staff online :'(";
      }
      return stringstaff;
    };
      ...
      if (this.msgData.message.length > 10) {
        ...
        for (id in _ref22) {
          ...
          if (u.getUser().username === name) {
            u.updateActivity();
            API.sendChat('@' + u.getUser().username + ' AFK status reseted.');
            return;
          }
        }
        API.sendChat('' + name + ' Cant be found');
      } else {
        API.sendChat('wat?');
      }
    };
  ...
  forceSkipCommand = (function(_super) {
    ...
    forceSkipCommand.prototype.functionality = function() {
      ...
      if (msg.length > 11) {
        ...
        if (param === 'On') {
          data.forceSkip = true;
          return API.sendChat("Forcedpush on.");
        } else if (param === 'Off') {
          data.forceSkip = false;
          return API.sendChat("Forcedpush offline.");
        }
      }
    };
  ...
  whyMehCommand = (function(_super) {
    ...
    whyMehCommand.prototype.functionality = function() {
      var msg;
      msg = "/em LOL mod online! ";
      msg += "Stoled your vacancy on college, your girls and all your Money BAI!";
      return API.sendChat(msg);
    };
        ...
        for (id in _ref29) {
          ...
          if (u.getUser().username === givenName) {
            ...
            if (disconnectInstances.length > 0) {
              ...
              resp += 'Your last dc was ' + dcTimeStr + ' (' + dcSongsAgo + ' songs ago). ';
              if (recentDisconnect.waitlistPosition !== void 0) {
                resp += 'Ele estava ' + recentDisconnect.waitlistPosition + ' songs';
                if (recentDisconnect.waitlistPosition > 1) {
                  resp += '';
                }
                resp += ' before the DJ Booth.';
              } else {
                resp += 'He wasnt in the DJ Booth.';
              }
              API.sendChat(resp);
              return;
            } else {
  ...
  avgVoteRatioCommand = (function(_super) {
    ...
    avgVoteRatioCommand.prototype.functionality = function() {
      ...
      msg = "Counting " + roomRatios.length.toString() + " votes per user, the voteratio is " + averageRatio.toFixed(2).toString() + " votes.";
      return API.sendChat(msg);
    };
